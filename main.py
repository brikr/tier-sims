...
def process_profile(name, download_url, tier_set_name, spec_name):
    ...
    profileset_lines = [
        "",
        f'profileset."0p"+=set_bonus=name={tier_set_name},pc=2,enable=0,',
        f'profileset."0p"+=set_bonus+=name={tier_set_name},pc=4,enable=0,',
        "",
        f'profileset."2p"+=set_bonus=name={tier_set_name},pc=2,enable=1,',
        f'profileset."2p"+=set_bonus+=name={tier_set_name},pc=4,enable=0,',
    ]
